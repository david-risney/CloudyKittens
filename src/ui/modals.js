...
export function openShopModal(root, opts) {
...
export function openLookupModal(root, opts) {
    ...
    function refresh() {
        ...
        const likes = Object.keys(c.likes);
        ...
        right.append(el('p', 'lookup-hunger', `Hunger: ${hungerLabel(c.hunger)} (${Math.round(c.hunger)})`));
